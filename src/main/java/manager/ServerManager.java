...
public class ServerManager {
    ...
    public static void main(String[] args) {
        try {
            ...
            String p1 = "Андрей Гришин";
                String p2 = "Вячеслав Горбунов";
